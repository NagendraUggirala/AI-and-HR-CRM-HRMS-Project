...
>
  ...
  <span className={`text-2xl font-bold transition-colors duration-300 ${
    ...
    <span style={{ color: isScrolled ? '#1F2937' : '#FFFFFF' }}>Recruitment</span>
  </span>
</Link>
              ...
              >
                {link.dropdown ? (
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 inline-block ${
                      isScrolled
                        ? 'text-gray-700 hover:text-blue-600 hover:bg-blue-50'
                        : 'text-white hover:bg-white hover:bg-opacity-20'
                    }`}
...
{link.dropdown && activeDropdown === index && (
    ...
    {link.items.map((item, itemIndex) => (
      ...
      >
        ...
        <div className="flex-1">
          ...
          <span className="text-xs text-gray-500 block leading-tight">{item.description}</span>
        </div>
      </button>
    ))}
  </div>
 ...
 <button
              ...
              className="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg"
            >
             Sign in
            </button>
            <button
